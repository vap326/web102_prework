...
const summaryString = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${numUnfundedGames} game${numUnfundedGames == 1 ? '' : 's'} remain unfunded. We need your help to fund these amazing games!`;
